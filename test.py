...
def Settings_Window(title, width, height):
    window_settings = pgame.display.set_mode((width, height))
    pgame.display.set_caption(title)
    return window_settings

def bttn1_callback():
    print("Button1 clicked.!!!!")

def bttn2_callback():               ## Setting Button
    window_settings = Settings_Window("Settings", 950, 540)
    print("Settings open")
